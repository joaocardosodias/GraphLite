...
//!
//! Graphite combines high-performance Compressed Sparse Row (CSR) graph topology
...
//!
//! ```rust
//! use graphite::{GraphiteConfig, GraphiteEngine, QueryOptions};
//!
...
pub use engine::{
    GraphiteConfig, GraphiteEngine, QueryOptions, QueryResult, ResolutionConfig, ResolutionResult,
};
...
pub type Graphite = GraphiteEngine;

/// Common prelude module for convenient imports.
pub mod prelude {
    pub use crate::engine::{GraphiteConfig, GraphiteEngine, QueryOptions, QueryResult};
    pub use crate::error::{GraphiteError, Result as GraphiteResult};
