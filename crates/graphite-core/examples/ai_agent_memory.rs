...
//!
//! Demonstrates how an AI agent uses Graphite to maintain a persistent,
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("============================================================");
    println!("       Graphite: AI Agent Long-Term Memory Lifecycle       ");
    println!("============================================================\n");
    ...
    {
        let db = GraphiteEngine::open_or_create(&memory_db_path, config.clone())?;
    ...
    {
        let db = GraphiteEngine::open_or_create(&memory_db_path, config)?;
        ...
        println!(
            "=== Context Retrieved by Graphite ({} tokens) ===",
            result.token_count
        );
        println!("{}\n", result.markdown);
